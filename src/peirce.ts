...
export const runPeirce = (): void => {
    const newFile = vscode.Uri.parse('untitled:peirce-output.md');

    vscode.workspace.openTextDocument(newFile).then(async summaryFile => {
        ...
        console.log(data);
        notesSummary = JSON.stringify(data); 
